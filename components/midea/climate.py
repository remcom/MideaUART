...
@register_action("display_toggle", DisplayToggleAction, cv.Schema({}))
async def display_toggle_to_code(var, config, args):
    pass


@register_action("swing_step", SwingStepAction, cv.Schema({}))
async def swing_step_to_code(var, config, args):
    pass


@register_action("beeper_on", BeeperOnAction, cv.Schema({}))
async def beeper_on_to_code(var, config, args):
    pass


@register_action("beeper_off", BeeperOffAction, cv.Schema({}))
async def beeper_off_to_code(var, config, args):
    pass


@register_action("power_on", PowerOnAction, cv.Schema({}))
async def power_on_to_code(var, config, args):
    pass


@register_action("power_off", PowerOffAction, cv.Schema({}))
async def power_off_to_code(var, config, args):
    pass


@register_action("power_toggle", PowerToggleAction, cv.Schema({}))
